public class SetTester {
    public static void main(String[] args) {
        ...
        s1.addToSet(3);
        s1.removeFromSet(1);
        System.out.println("Set {3,5} after removing element 1 should be {3,5}. Yours is: " + s1 + " - " + getOutputText("{3,5}".equals(s1.toString())));
        ...
        s2.addToSet(3);
        s3 = s1.union(s2);
        System.out.println("union between sets " + s1 + " and " + s2 + " should be: {1,3,9} - " + getOutputText("{1,3,9}".equals(s3.toString())));
